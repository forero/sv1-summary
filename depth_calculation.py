...
ROOT = Path('/global/cfs/cdirs/desi/spectro/redux/daily/')
assert ROOT.exists()
...
if (campaign=='minisv2'):
    ...
    gfa_results = fitsio.read('desi_sv1_exposures_gfa.fits', ext=1)    
...
if (campaign=='minisv2'):
    ...
    gfa_results.write("desi_sv1_exposures_gfa_with_depth.fits",overwrite=True)
